...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"foo1 i value = {foo.i}");
        Console.WriteLine($"foo2 i value = {foo.i}");
        Console.WriteLine($"foo1 j value = {foo1.j}");
        Console.WriteLine($"foo2 j value = {foo2.j}");

        foo.MultiplyToProduct(3.4f);
        foo.MultiplyToProduct(10.0f);
        foo.MultiplyToProduct(0.0241f);

        Console.WriteLine($"foo1 product value = {foo.product}");
