...
public partial class FreeCharacterDbContext : DbContext
{
    public FreeCharacterDbContext()
    {
    }

    public FreeCharacterDbContext(DbContextOptions<FreeCharacterDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Characte__3213E83F9F0FD224");

            entity.ToTable("Characters", "normalized_dndrpg");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Characte__3213E83FEDB841AA");

            entity.ToTable("CharacterClasses", "normalized_dndrpg");
            ...
            entity.HasOne(d => d.Character).WithMany(p => p.CharacterClasses)
                ...
                .HasConstraintName("FK__Character__chara__6477ECF3");

            entity.HasOne(d => d.Class).WithMany(p => p.CharacterClasses)
                .HasForeignKey(d => d.ClassId)
                .HasConstraintName("FK__Character__class__6383C8BA");
        });

        modelBuilder.Entity<Class>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Classes__3213E83FF4E85FD4");

            entity.ToTable("Classes", "normalized_dndrpg");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Features__3213E83F0A6E7B0D");

            entity.ToTable("Features", "normalized_dndrpg");
            ...
            entity.HasOne(d => d.Class).WithMany(p => p.Features)
                .HasForeignKey(d => d.ClassId)
                .HasConstraintName("FK__Features__classI__60A75C0F");
        });
